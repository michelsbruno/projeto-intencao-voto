...
<div class="card">
  <div class="card-header">
     Qual cargo político você tem interesse em votar? 
  </div>
  <div class="card-body">
    <!-- formulário -->
...
<script type="text/javascript">
  function enviarFormulario() {
    ...
    if (opcaoSelecionada === '1') {
      ...
      window.location.href = 'votacao.php?cargo=1';
    } else if (opcaoSelecionada === '2') {
      window.location.href = 'votacao_governador.php?cargo=2';
    } else if (opcaoSelecionada === '3') {
      window.location.href = 'valida_votacao.php?id_funcao=3';
    }
  }
</script>
