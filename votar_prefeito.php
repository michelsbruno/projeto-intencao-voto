...
<head>
  ...
  <title>Escolha de candidato</title>
  <style type="text/css">
    body {
      /* display: flex; */
      align-items: center;
  ...
  <div class="card">
    <div class="card-header">
      <?php 
        ...
        $sql_cargo = "select nome_cidade from cidade where id_cidade = " . $cidade;
        ...
        echo "Vote para o Prefeito de <b>" . $nome_cidade ."</b>";
