...
<body>
    ...
    <?php
        ...
        <div class="card-body">
            ...
            $sql = "SELECT c.nome, COALESCE(COUNT(p.id_candidato), 0) AS total_votos, pa.nm_partido as nome_partido,
                    (COALESCE(COUNT(p.id_candidato), 0) / (SELECT COUNT(*) FROM cadastro_pesquisa WHERE id_funcao = 1 AND id_cidade = $id_cidade)) * 100 AS porcentagem
                     FROM candidato c
                     LEFT JOIN cadastro_pesquisa p ON c.id_candidato = p.id_candidato AND c.id_cidade = $id_cidade
            ...
            ?>
                ...
                <p>Número de Votos: <?php echo $totalVotos; ?></p>
